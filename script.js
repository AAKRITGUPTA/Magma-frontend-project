...
loco();
var clutter = " ";
document.querySelector("#page2>h1").textContent.split(" ").forEach(function(ele){
...
var clutter = " ";
document.querySelector("#page4>h1").textContent.split(" ").forEach(function(ele){
    clutter += `<span> ${ele} </span>`
    console.log(ele)
...
var clutter = " ";
document.querySelector("#page6>h1").textContent.split(" ").forEach(function(ele){
    clutter += `<span> ${ele} </span>`
    console.log(ele)
